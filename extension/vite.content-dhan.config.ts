...
/**
 * Sixth build pass: the Dhan order-window capture content script. Chrome
...
export default defineConfig({
  ...
  build: {
    ...
    emptyOutDir: false,
    rollupOptions: {
      input: path.resolve(dir, "src/content/dhan-capture.ts"),
      output: { format: "iife", entryFileNames: "content-dhan.js" },
    },
  },
});
