...
/**
 * Fifth build pass: the Groww order-window capture content script. Chrome
...
export default defineConfig({
  ...
  build: {
    ...
    emptyOutDir: false,
    rollupOptions: {
      input: path.resolve(dir, "src/content/groww-capture.ts"),
      output: { format: "iife", entryFileNames: "content-groww.js" },
    },
  },
});
