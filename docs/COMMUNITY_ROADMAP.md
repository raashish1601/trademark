...
4. [x] **Decayed, cost-weighted Top-feed hot-score** — comments/reshares weigh more than reactions, recency decay, per-author diversity cap; deterministic, no ML. _(2026-06-13, PR #72)_
5. [x] **Link OG unfurl preview cards** — SSRF-safe host allowlist for fetched links + own OG tags on posts. _(2026-06-13, PR #72)_
