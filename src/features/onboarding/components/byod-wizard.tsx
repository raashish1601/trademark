  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <Button className="w-full" disabled={busy || !url || !token} onClick={() => connect(url, token)}>
      ...
      <div className="border-t pt-3 space-y-2">
        ...
        <div className="flex gap-2">
          <Input value={importKey} onChange={(e) => setImportKey(e.target.value)} placeholder="Connection key" />
          <Button
            variant="outline"
