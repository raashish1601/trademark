...
export default function GlobalError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <html lang="en">
      <body style={{ fontFamily: "system-ui, sans-serif", background: "#0A0A0B", color: "#FAFAFA" }}>
        <div style={{ minHeight: "100dvh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 12, padding: 24, textAlign: "center" }}>
          ...
          <button
            onClick={reset}
            style={{ marginTop: 8, background: "#8B5CF6", color: "#fff", border: 0, borderRadius: 8, padding: "10px 20px", fontWeight: 600, cursor: "pointer" }}
          >
            Reload
          </button>
        </div>
