...
import { CommunityAvatar, PostCard, useUpdateProfile, useUserProfile } from "@/features/community";
        ...
        <DialogContent className="max-w-sm">
          ...
          <form className="space-y-3" onSubmit={saveProfile}>
            <div className="space-y-1.5">
              ...
              <Input id="pf-name" name="displayName" defaultValue={profile.displayName} maxLength={40} required />
            </div>
            <div className="space-y-1.5">
            ...
            <div className="space-y-1.5">
              ...
              <Textarea id="pf-bio" name="bio" defaultValue={profile.bio ?? ""} maxLength={280} rows={3} placeholder="Index options scalper · 3 years in the market" />
            </div>
            <Button type="submit" className="w-full" disabled={updateProfile.isPending} aria-busy={updateProfile.isPending}>
